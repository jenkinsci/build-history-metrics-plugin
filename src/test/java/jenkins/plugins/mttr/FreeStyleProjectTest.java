 ...
 *
 * <p>Previously was IntegrationTest renamed as MTTR expanded to all jobs, this
 * is regression
 *
 * @author nick
 */
public class FreeStyleProjectTest {
  ...
  public void setUp() throws Exception {
    project =
        jenkins.getInstance().createProject(FreeStyleProject.class, "fsp_test");
    ...
    if (System.getProperty("os.name").startsWith("Windows")) {
      ...
      project
          .getBuildersList()
          .add(new BatchFile("SET /a ret=%BUILD_NUMBER%%%2\n" + "exit %ret%"));
    } else {
      // everything else
      project
          .getBuildersList()
          .add(new Shell("return `expr $BUILD_NUMBER % 2`"));
    }
