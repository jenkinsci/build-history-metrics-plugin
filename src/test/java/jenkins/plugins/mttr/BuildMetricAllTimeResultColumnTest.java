...
public class BuildMetricAllTimeResultColumnTest {
  ...
  public void test_GetResult() throws Exception {
    ...
    assertEquals(
        "MTTR_All_DAYS is incorrect", EXPECTED_MTTR_ALL_AS_STRING, resultColumn.getResult(project));
  }
  ...
  public void test_GetGraph() throws Exception {
    AbstractProject project = CreateMockProject();
    BuildMetricAllTimeResultColumn instance = new BuildMetricAllTimeResultColumn();
