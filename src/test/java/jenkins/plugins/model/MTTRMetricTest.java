...
class MTTRMetricTest {
    ...
    @Test
    void should_return_failed_info_when_have_all_builds_regardless_of_order_they_are_added() {
    ...
    private void runAndVerifyResult(List<BuildMessage> builds, long expectTime, int expectCount) {
        ...
        assertEquals("test", mttrMetric.getName(), "Metric Name");
        assertEquals(expectTime, mttrMetric.calculateMetric(), "MTTR Metric");
        assertEquals(expectCount, mttrMetric.getOccurences(), "Build Count");
    }
}
